...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView orderView = (TextView) convertView.findViewById(R.id.order) ;
        TextView titleTextView = (TextView) convertView.findViewById(R.id.title) ;
        TextView writerView = (TextView) convertView.findViewById(R.id.writer) ;
        TextView goalView = (TextView) convertView.findViewById(R.id.goal) ;
        ...
        // 아이템 내 각 위젯에 데이터 반영
        orderView.setText(listViewItem.getOrder());
        titleTextView.setText(listViewItem.getTitle());
        writerView.setText(listViewItem.getWriter());
        goalView.setText(listViewItem.getGoal());
